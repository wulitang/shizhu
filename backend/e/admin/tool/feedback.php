...
<div class="ui-tab-content">
          ...
          <select name="bid" id="bid" onchange=window.location='feedback.php?<?=$ecms_hashur['ehref']?>&bid='+this.options[this.selectedIndex].value>
            ...
            <?=$gbclass?>
          </select> <a href="FeedbackClass.php<?=$ecms_hashur['whehref']?>" class="gl">管理反馈分类</a> <a href="ListFeedbackF.php<?=$ecms_hashur['whehref']?>" class="gl">管理反馈字段</a></span></h3>
            <div class="line"></div>
<div class="anniuqun">
