...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="main.php">后台首页</a> > <a href="../ListAllInfo.php<?=$ecms_hashur['whehref']?>">管理信息</a> &gt; <a href="ListWfInfo.php<?=$ecms_hashur['whehref']?>">管理签发信息</a></div>
</div>
