...
<table class="comm-table anniuqun" cellspacing="0">
	<tbody>
		<tr>
			<th style="width:140px;"><h3><span style="padding-left: 0px;">基本属性</span></h3></th>
			<th></th>
		</tr>
    <tr> 
    ...
    <tr> 
      ...
      <td bgcolor="#FFFFFF"> <table border="0" cellspacing="1" cellpadding="3" class="comm-table2" style="width:400px;">
          <tr style="border-left:1px solid #CDCDCD;"> 
            ...
            <th style="line-height: 26px;height: 26px;">本分类目录</th>
            <th style="line-height: 26px;height: 26px;">&nbsp;</th>
          </tr>
          <tr> 
            <td nowrap="nowrap"><div align="right">根目录/</div></td>
	...
	<tr>
			<th style="width:140px;"><h3><span style="padding-left: 0px;">页面设置</span></h3></th>
			<th></th>
	</tr>
    <tr> 
    ...
    <tr> 
      ...
      <td height="25" bgcolor="#FFFFFF"> <select name="listtempid" id="listtempid">
          <?=$listtemp_options?>
        </select> <input type="button" name="Submit622" value="管理列表模板" onclick="gllbmb()">
        *</td>
    </tr>
    <tr> 
	...
	<tr>
			<th style="width:140px;"><h3><span style="padding-left: 2px;">JS相关设置</span></h3></th>
			<th></th>
	</tr>
    <tr> 
