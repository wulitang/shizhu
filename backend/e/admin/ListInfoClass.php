...
//导入采集规则
function drcjgz(){
art.dialog.open('cj/LoadInCj.php<?=$ecms_hashur[whehref]?>',
...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="main.php">后台首页</a> > 采集 &gt; <a href="ListInfoClass.php<?=$ecms_hashur[whehref]?>">管理节点</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理节点 <a href="AddInfoC.php<?=$ecms_hashur[whehref]?>" class="add">增加节点</a> <a href="javascript:void(0)" onclick="drcjgz()" class="dr">导入采集规则</a></span></h3>
            <div class="line"></div>
<div class="jqui">
...
?>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="25" colspan="7" style="text-align:left;">
        &nbsp;&nbsp;<input type="submit" name="Submit" value="批量采集节点">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25" colspan="8" style="text-align:left;"><font color="#666666">备注：弹出采集窗口，请按住&quot;Shift&quot;+点击”开始采集&quot;</font></td>
    </tr>
	</tbody>
</table>
</form>
