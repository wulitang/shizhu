...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="DelData.php<?=$ecms_hashur['whehref']?>">按条件删除信息</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>按条件删除信息</span></h3>
            <div class="line"></div>
<div class="jqui">
...
<form action="../ecmsinfo.php" method="get" name="form1" onSubmit="return confirm('确认要删除?');">
 <?=$ecms_hashur['form']?>
		<tr>
			<th colspan="2">按条件删除信息</th>
		</tr>
   		   <tr> 
      <td height="25" bgcolor="#FFFFFF" style="width:180px;">选择数据表</td>
      <td bgcolor="#FFFFFF"><select name="tbname" id="tbname">
    ...
    <tr>
      <td height="25" colspan="2" bgcolor="#FFFFFF">说明: 会员为前台注册会员，用户为后台管理员。删除后的数据不能恢复,请谨慎使用。</td>
      </tr>
        </form>
	</tbody>
</table>
