...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="main.php<?=$ecms_hashur['whehref']?>">后台首页</a> > <a href="ListZt.php<?=$ecms_hashur['whehref']?>">管理专题</a> &gt; <a href="ListZtClass.php<?=$ecms_hashur['whehref']?>">管理专题分类</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理专题分类</span></h3>
            <div class="line"></div>
<div class="jqui">
<table class="comm-table anniuqun" cellspacing="0">
  ...
  <form name=form2 method=post action=../ecmscom.php>
    ...
    <input type=hidden name=classid value=<?=$r[classid]?>>
		<tr>
			<td><?=$r[classid]?></td>
			<td><input name="classname" type="text" id="classname" value="<?=$r[classname]?>"></td>
			<td>
  ...
  <form name="form1" method="post" action="../ecmscom.php">
    <?=$ecms_hashur['form']?>
        ...
        <input name=doing type=hidden value=zt>
  		<tr> 
          <td style="background:#DBEAF5;">增加专题分类:</td>
