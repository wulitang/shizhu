...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListPicNews.php<?=$ecms_hashur['whehref']?>">管理图片信息</a></div></div>
...
<div class="ui-tab-content">
      ...
      <select name="classid" id="classid" onchange=window.location='ListPicNews.php?<?=$ecms_hashur['ehref']?>&classid='+this.options[this.selectedIndex].value>
		...
		<?=$class?>
      </select> <a href="AddPicNews.php?enews=AddPicNews<?=$ecms_hashur['ehref']?>" class="add">增加图片信息</a> <a href="PicClass.php<?=$ecms_hashur['whehref']?>" class="gl">管理图片信息分类</a></span></h3>
            <div class="line"></div>
<div class="anniuqun">
...
<input type="submit" name="Submit" value="批量删除"></td>
          ...
          <tr>
  		  <td colspan="3"><font color="#666666">JS调用方式：&lt;script src= 
        <?=$public_r[newsurl]?>
