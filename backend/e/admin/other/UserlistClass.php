...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListUserlist.php<?=$ecms_hashur['whehref']?>">管理自定义列表</a> &gt; <a href="UserlistClass.php<?=$ecms_hashur['whehref']?>">管理自定义列表类别</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理自定义列表类别</span></h3>
            <div class="line"></div>
<div class="jqui">
<table class="comm-table anniuqun" cellspacing="0">
  ...
  <form name="form1" method="post" action="../ecmscom.php">
    <?=$ecms_hashur['form']?>
		...
		<input name=doing type=hidden value=userlist>
  		<tr> 
          <td style="background:#DBEAF5;">增加自定义列表类别: </td>
