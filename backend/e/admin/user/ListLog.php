...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > 日志管理 &gt; <a href="ListLog.php<?=$ecms_hashur['whehref']?>">管理登陆日志</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理登陆日志 <a href="ListDolog.php<?=$ecms_hashur['whehref']?>" class="gl">管理操作日志</a></span></h3>
            <div class="line"></div>
<div class="anniuqun">
...
<?=$ecms_hashur['form']?>
	<tbody>
		<tr>
			<th><a href="ListLog.php?orderby=0&mydesc=<?=$loginiddesc.$search2?>">ID</a></th>
			<th><a href="ListLog.php?orderby=1&mydesc=<?=$usernamedesc.$search2?>">登陆用户</a></th>
            <th><a href="ListLog.php?orderby=2&mydesc=<?=$statusdesc.$search2?>">状态</a></th>
            <th><a href="ListLog.php?orderby=3&mydesc=<?=$loginipdesc.$search2?>">登陆IP</a></th>
            <th><a href="ListLog.php?orderby=4&mydesc=<?=$logintimedesc.$search2?>">登陆时间</a></th>
            <th>删除</th>
		</tr>
 <?
