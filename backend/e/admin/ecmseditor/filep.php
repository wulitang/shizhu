...
<body>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table">
  <tr> 
    <td> 当前目录：<strong>/ 
      <?=$filepath?>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" >
  <form name="dofile" method="post" action="../ecmsfile.php">
    ...
    <tr>
      ...
      <th height="25"><div align="center">文件名</div></th>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="39%" height="25"><div align="left"><img src="<?=$img?>" width="23" height="22"><a href=<?=$filelink?><?=$target?>> 
        <?=$filename?></div>
        </a></td>
      <td width="20%"> 
