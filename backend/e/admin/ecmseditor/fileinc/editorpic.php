...
while($r=$empire->fetch($sql))
{
	...
	$class_text.="<td width='33%'><table width='100%' border='0' cellspacing='1' cellpadding='2'>
  <tr> 
...
if($i<>0)
{
	$table="<table width='100%' border=0 cellpadding=3 cellspacing=1 class='comm-table anniuqun'>
				<tr>
					<th>图片 (点击图片选择)</th>
				</tr>
				<tr>
