...
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="anniuqun">
  <tr valign="top"> 
    <td width="68%"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table">
        <form action="ecmseditor.php" target="ECUploadWindow" method="post" enctype="multipart/form-data" name="etform" onSubmit="return ReturnFileNo(document.etform);">
          ...
          <tr> 
            <th colspan="2">上传<?=$tranname?>附件</th>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="16%">远程保存</td>
            <td width="84%" style="text-align:left;"><input name="tranurl" type="text" id="tranurl" value="http://" size="36"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td>本地上传</td>
            <td style="text-align:left;"><input name="file" type="file" size="32"> </td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td>文件别名</td>
            <td style="text-align:left;"><input name="no" type="text" id="no" value="<?=$_GET['fileno']?>" size="36"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td>图片选项</td>
            <td style="text-align:left;"> <input name="getmark" type="checkbox" id="getmark" value="1"> 
          ...
          <tr bgcolor="#FFFFFF"> 
            <td>&nbsp;</td>
            <td style="text-align:left;"><input type="submit" name="Submit3" value="上传"></td>
          </tr>
        </form>
      </table>
...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="comm-table anniuqun">
