...
<table class="comm-table" cellspacing="0">
	<tbody>
		...
		<tr>
			<td width="180" valign="top"><select name="classid[]" size="73" multiple id="classid[]" style="width:180px">
            <?=$do_class?>
          </select></td>
			<td valign="top">
            <style>.comm-table2 td{ text-align:left; padding:5px 10px;}</style>
            <table width="100%" border="0" cellpadding="3" cellspacing="1" class="comm-table2 anniuqun" id="changecolor">
          <tr> 
            <th height="25" style="border-left:1px solid #CDCDCD;"><div align="center">修改</div></th>
            <th colspan="2">设置项目</th>
          </tr>
          <tr> 
            <td height="30" colspan="3">基本属性设置</td>
          </tr>
          <tr> 
            <td height="25"> <div align="center"> 
                <input name="doclasstype" type="checkbox" id="doclasstype" value="1">
              </div></td>
            <td width="23%">栏目文件扩展名</td>
            <td width="71%"> <input name="classtype" type="text" id="classtype" value=".html" size="10"> 
          ...
          <tr> 
            ...
            <td>每页显示记录数</td>
            <td><input name="lencord" type="text" id="lencord" value="25" size="5">
              条</td>
          </tr>
          <tr> 
            <td height="25"> <div align="center"> 
...
<input type="radio" name="listdt" value="1"<?=$r[listdt]==1?' checked':''?>>
          ...
          <tr> 
            ...
            <td>开放投稿功能</td>
            <td><input name="openadd" type="radio" value="0" checked<?=$openadd0?>>
              是 
              <input type="radio" name="openadd" value="1"<?=$openadd1?>>
              否</td>
          </tr>
          <tr> 
            <td height="30" colspan="3"><strong>选项设置[大栏目]</strong></td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
          ...
          <tr> 
            ...
            <td>列表式</td>
            <td><input type="radio" name="islist" value="0"<?=$r[islist]==0?' checked':''?>>
              封面式 
          ...
          <tr> 
            <td height="30" colspan="3"><strong>选项设置[终极栏目]</strong></td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
          ...
          <tr> 
            ...
            <td>相关链接显示记录数</td>
            <td><input name="link_num" type="text" id="link_num" value="10" size="5">
          ...
          <tr> 
            ...
            <td>信息页目录存放形式</td>
            <td><input name="newspath" type="text" id="newspath" value="<?=$r[newspath]?>" size="10"> 
          ...
          <tr> 
            ...
            <td>信息页文件名前缀</td>
            <td> <input name="filename_qz" type="text" id="filename_qz" value="<?=$r[filename_qz]?>" size="15"> 
            </td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>信息页文件命名规则</td>
            <td><input name="filename" type="radio" value="0" checked>
              信息ID 
          ...
          <tr> 
            ...
            <td>信息页文件扩展名</td>
            <td><input name="filetype" type="text" id="filetype" value=".html" size="10"> 
          ...
          <tr> 
            ...
            <td>是否开放评论功能</td>
            <td><input name="openpl" type="radio" value="0" checked<?=$openpl0?>>
              是 
          ...
          <tr> 
            ...
            <td>评论需要审核</td>
            <td><input name="checkpl" type="checkbox" id="checkpl2" value="1"<?=$checkpl?>>
              是</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>投稿开启验证码</td>
            <td><input name="qaddshowkey" type="checkbox" id="qaddshowkey2" value="1"<?=$r['qaddshowkey']==1?' checked':''?>>
              是 </td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>投稿需要审核</td>
            <td><input name="checkqadd" type="checkbox" id="checkqadd2" value="1"<?=$r['checkqadd']==1?' checked':''?>>
              直接通过审核</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
          ...
          <tr> 
            ...
            <td>投稿生成列表</td>
            <td><select name="qaddlist" id="qaddlist">
          ...
          <tr> 
            ...
            <td>单篇投稿审核后获得</td>
            <td><input name="addinfofen" type="text" id="addinfofen" value="<?=$r[addinfofen]?>" size="6">
          ...
          <tr> 
            ...
            <td>发布信息生成内容页</td>
            <td><input name="addreinfo" type="checkbox" id="addreinfo" value="1"<?=$r['addreinfo']==1?' checked':''?>>
              是</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>发布信息生成列表</td>
            <td><select name="haddlist" id="haddlist">
          ...
          <tr> 
            ...
            <td>检测标题重复</td>
            <td><input name="sametitle" type="checkbox" id="sametitle" value="1"<?=$r['sametitle']==1?' checked':''?>>
              是</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>发布信息是否直接审核</td>
            <td><input name="checked" type="checkbox" id="checked" value="1"<?=$checked?>>
              是</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
            ...
            <td>发布信息生成上一篇信息</td>
            <td><input name="repreinfo" type="checkbox" id="repreinfo" value="1"<?=$r[repreinfo]==1?' checked':''?>>
              是</td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
          ...
          <tr> 
            <td height="30" colspan="3"><strong>特殊模型设置</strong></td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
          ...
          <tr> 
            <td height="30" colspan="3"><strong>JS调用设置</strong></td>
          </tr>
          <tr> 
            <td height="25"><div align="center"> 
