...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListTags.php<?=$ecms_hashur['whehref']?>">管理TAGS</a> &gt; <a href="TagsClass.php<?=$ecms_hashur['whehref']?>">管理TAGS分类</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理TAGS分类</span></h3>
            <div class="line"></div>
<div class="jqui">
...
<input name=enews type=hidden id="enews" value=AddTagsClass>
		<input name=doing type=hidden value=tags>
  		<tr> 
          <td style="background:#DBEAF5;">增加TAGS分类: </td>
