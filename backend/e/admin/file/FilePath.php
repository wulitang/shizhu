...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a>附件管理</a> > <a href="FilePath.php<?=$ecms_hashur['whehref']?>">管理附件 (目录式)</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>当前目录：<strong>/ 
      <?=$filepath?>
      </strong> [<a href="#ecms" onclick="javascript:window.history.go(-1);return false;">返回上一页</a>]</span></h3>
            <div class="line"></div>
<div class="anniuqun">
...
<table class="comm-table" cellspacing="0">
   ...
   <?php
    ...
    <tr bgcolor="#FFFFFF" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#C3EFFF'"> 
      ...
      <td> <div align="left"><img src="<?=$img?>" width="23" height="22"><a href=<?=$filelink?><?=$target?>> 
        <?=$filename?>
        </a></div></td>
      <td> <div align="center">
          <?=$filesize?>
