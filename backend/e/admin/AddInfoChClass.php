...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href='ListAllInfo.php<?=$ecms_hashur[whehref]?>'>管理信息</a>&nbsp;&gt;&nbsp;增加信息</div></div>
...
<div align="center"> 
          <select name="addclassid" size="26" id="addclassid" onchange='javascript:changeclass(document.form1);' style="width:420px">
            <?=$do_class?>
          </select>
        </div></td>
    </tr>
