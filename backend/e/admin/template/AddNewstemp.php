...
//查看其他js
function ckqtjs(){
art.dialog({title: '查看变量',content: document.getElementById('qtjs'),padding:0,width:700, height:275,button: [{name: '关闭'}]
	});
}
//查看内容字段
function cknrzd(){
...
//管理分类
function glfl(){
art.dialog.open('template/NewstempClass.php<?=$ecms_hashur[whehref]?>',
...
<table class="comm-table anniuqun" cellspacing="0">
	<tbody>
		<tr>
			<th style="width:140px;"><h3><span>增加内容模板</span></h3></th>
			<th></th>
		</tr>
      <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
    <td height="25">查看说明:</td>
      <td height="25" style="text-align:left;">[<a href="javascript:void(0)" onclick="ckbl()">显示模板变量说明</a>] 
        &nbsp;[<a href="javascript:void(0)" onclick="cknrzd()">查看内容字段</a>] 
        &nbsp;[<a href="javascript:void(0)" onclick="ckqtjs()">★其它JS调用</a>] &nbsp;[<a href="javascript:void(0)" onclick="ckmbbq()">查看模板标签语法</a>]
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5" class="comm-table2">
		  ...
		  <tr bgcolor="#FFFFFF"> 
			 ...
			 <td height="25"><strong>支持所有模板标签</strong></td>
			<td>&nbsp;</td>
          </tr>
        </table>
</div>
<div id="qtjs" style="display:none">
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5" class="comm-table2">
<tr>
          	<th style="border-left:1px solid #CDCDCD;" colspan="3">其它JS调用及地址说明</th>
          </tr>
          <tr bgcolor="#FFFFFF"> 
          ...
          <tr bgcolor="#FFFFFF"> 
            <td rowspan="2">上面多变量同时显示<br>
              (变量1为显示,0为不显示) </td>
            <td height="25"><input name="textfield6722" type="text" value="&lt;script src=[!--news.url--]e/public/ViewClick/ViewMore.php?classid=[!--classid--]&amp;id=[!--id--]&amp;onclick=1&amp;down=1&amp;plnum=1&amp;pfen=0&amp;pfennum=0&amp;diggtop=0&amp;diggdown=0&amp;addclick=0&gt;&lt;/script&gt;" style="WIDTH: 100%"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
