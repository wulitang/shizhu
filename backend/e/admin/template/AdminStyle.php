...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="AdminStyle.php<?=$ecms_hashur['whehref']?>">管理后台样式</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理后台样式</span></h3>
            <div class="line"></div>
<div class="jqui">
...
<?=$ecms_hashur['form']?>
        <input name=enews type=hidden id="enews" value=AddAdminStyle>
  		<tr> 
          <td style="background:#DBEAF5;">增加后台样式: </td>
		  <td colspan="4" style="text-align:left;background:#DBEAF5;">样式名称: 
