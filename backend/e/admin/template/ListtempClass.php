...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListListtemp.php<?=$ecms_hashur['whehref']?>">管理列表模板</a> &gt; <a href="ListtempClass.php<?=$ecms_hashur['whehref']?>">管理列表模板分类</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理列表模板分类</span></h3>
            <div class="line"></div>
<div class="jqui">
...
<?=$ecms_hashur['form']?>
		...
		<input name=doing type=hidden value=listtemp>
  		<tr> 
          <td style="background:#DBEAF5;">增加列表模板分类:</td>
