...
//管理分类
function glfl(){
art.dialog.open('template/JsTempClass.php<?=$ecms_hashur['whehref']?>',
...
<table class="comm-table anniuqun" cellspacing="0">
	<tbody>
		<tr>
			<th style="width:140px;"><h3><span>增加JS模板</span></h3></th>
			<th></th>
		</tr>
      <tr bgcolor="#FFFFFF"> 
      <td height="25">模板名称(*)</td>
      <td height="25" style="text-align:left;"><input name="tempname" type="text" id="tempname" value="<?=$r[tempname]?>" size="40"></td>
      </tr>
         <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25" style="text-align:left;">[<a href="javascript:void(0)" onclick="ckbl()">显示模板变量说明</a>] [<a href="javascript:void(0)" onclick="cknrzd()">内容字段变量</a>]</td> 
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25" colspan="2"><div align="center"> 
          <textarea name="temptext" cols="90" rows="18" id="temptext" wrap="OFF"><?=ehtmlspecialchars(stripSlashes($r[temptext]))?></textarea>
        </div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
