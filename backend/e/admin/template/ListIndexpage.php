...
art.dialog.open('template/AddIndexpage.php?enews=AddIndexpage&gid=<?=$gid?><?=$ecms_hashur['ehref']?>',
    {title: '增加首页方案',lock: true,opacity: 0.5, width: 800, height: 540,
	 close: function () {
      location.reload();
    }
	});
...
<div class="ui-tab-content">
        	<h3><span>管理首页方案 <a href="Javascript:addindexpage()" class="gl">增加首页方案</a></span></h3>
            <div class="line"></div>
<div class="jqui">
<table class="comm-table anniuqun" cellspacing="0">
 ...
 <?php
  ...
  <tr bgcolor="ffffff">
    <td height="25" colspan="4"><font color="#666666">说明：首页方案：可以将某一方案作为临时首页，特别是在节假日制作特别首页非常有用。全部取消时为使用默认首页模板。</font></td>
  </tr>
	</tbody>
</table>
