...
//管理分类
function glfl(){
art.dialog.open('template/SearchtempClass.php<?=$ecms_hashur[whehref]?>',
...
<table class="comm-table anniuqun" cellspacing="0">
	<tbody>
      ...
      <tr bgcolor="#FFFFFF"> 
      <td height="25">模板名(*)</td>
      <td height="25" colspan="2" style="text-align:left;"><input name="tempname" type="text" id="tempname" value="<?=$r[tempname]?>" size="36"> 
      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25">所属系统模型(*)</td>
      <td height="25" colspan="2" style="text-align:left;"><select name="modid" id="modid">
          <?=$mod?>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="25" colspan="2" style="text-align:left;"><select name="classid" id="classid">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="25" colspan="2" style="text-align:left;"><input name="subnews" type="text" id="subnews" value="<?=$r[subnews]?>" size="6">
        个字节<font color="#666666">(0为不截取)</font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25">标题截取字数</td>
      <td height="25" colspan="2" style="text-align:left;"><input name="subtitle" type="text" id="subtitle" value="<?=$r[subtitle]?>" size="6">
        个字节<font color="#666666">(0为不截取)</font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25">每次显示</td>
      <td height="25" colspan="2" style="text-align:left;"><input name="rownum" type="text" id="rownum" value="<?=$r[rownum]?>" size="6">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="2" style="text-align:left;"> <input name="showdate" type="text" id="showdate" value="<?=$r[showdate]?>" size="20"> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td colspan="2" style="text-align:left;">[<a href="javascript:void(0)" onClick="ckbl()">显示模板变量说明</a>]&nbsp;&nbsp;[<a href="javascript:void(0)" onClick="cknrzd()">查看内容字段</a>]
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25" colspan="2" style="text-align:left;"><p> <strong>页面模板内容：</strong>列表头[!--empirenews.listtemp--]列表内容[!--empirenews.listtemp--]列表尾<br>
