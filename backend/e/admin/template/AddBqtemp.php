...
//管理分类
function glfl(){
art.dialog.open('template/BqtempClass.php<?=$ecms_hashur['whehref']?>',
...
<table class="comm-table anniuqun" cellspacing="0">
	<tbody>
		<tr>
			<th style="width:140px;"><h3><span>增加标签模板</span></h3></th>
			<th></th>
		</tr>
      <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td style="text-align:left;">[<a href="javascript:void(0)" onclick="ckbl()">显示模板变量说明</a>] &nbsp;[<a href="javascript:void(0)" onclick="cknrzd()">查看内容字段</a>]</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25" colspan="2" valign="top"><div align="center"> 
          <textarea name="temptext" cols="90" rows="18" wrap="OFF" id="temptext"><?=ehtmlspecialchars(stripSlashes($r[temptext]))?></textarea>
        </div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25" valign="top"><strong>列表内容模板(list.var) </strong>(*)</td>
      <td height="25"><div align="right" class="right">
          <input name="docode" type="checkbox" id="docode" value="1"<?=$r[docode]==1?' checked':''?>><a title="list.var使用程序代码">使用程序代码</a></div>请将模板内容<a href="#ecms" onClick="window.clipboardData.setData('Text',document.form1.listvar.value);document.form1.listvar.select()" title="点击复制模板内容"><strong>复制到Dreamweaver(推荐)</strong></a>或者使用<a href="#ecms" onClick="window.open('editor.php?getvar=opener.document.form1.listvar.value&returnvar=opener.document.form1.listvar.value&fun=ReturnHtml&notfullpage=1','edittemp','width=880,height=600,scrollbars=auto,resizable=yes');"><strong>模板在线编辑</strong></a>进行可视化编辑</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25" colspan="3"><input type="submit" name="Submit" value="保存模板"> 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25" style="text-align:left;"><strong>页面模板内容：</strong>列表头[!--empirenews.listtemp--]列表内容[!--empirenews.listtemp--]列表尾<br>
