...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListBq.php<?=$ecms_hashur['whehref']?>">管理标签</a> &gt; <a href="BqClass.php<?=$ecms_hashur['whehref']?>">管理标签分类</a></div></div>
...
<?=$ecms_hashur['form']?>
		...
		<input name=doing type=hidden value=bq>
  		<tr> 
          <td style="background:#DBEAF5;">增加标签分类:</td>
