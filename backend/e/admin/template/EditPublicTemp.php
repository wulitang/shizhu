...
if($tname=="indextemp"||empty($tname)){
	$anniu="<a href='ListIndexpage.php?gid=$gid".$ecms_hashur['ehref']."' class='add'>管理首页方案</a>";
	}
?>
...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <?=$gname?>&nbsp;>&nbsp;<a href="EditPublicTemp.php?gid=<?=$gid?><?=$ecms_hashur['ehref']?>">公共模板管理</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>公共模板管理 <a href="../ReHtml/ChangeData.php<?=$ecms_hashur[whehref]?>" class="sx">进入数据更新</a> <?=$anniu?></span></h3>
            <div class="line"></div>
<?
if($tname=="indextemp"||empty($tname))
{
?>
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=indextemp>
	<form name="formindex" method="post" action="../ecmstemp.php">
	<?=$ecms_hashur['form']?>
    <tr> 
    <th>修改首页模板(<a href="../../../" target="_blank">预览</a>)</th>
    </tr>
    <tr>
      <td height="25"><div align="center">请将模板内容<a href="#ecms" onClick="window.clipboardData.setData('Text',document.formindex.temptext.value);document.formindex.temptext.select()" title="点击复制模板内容"><strong>复制到Dreamweaver(推荐)</strong></a>或者使用<a href="#ecms" onClick="window.open('editor.php?getvar=opener.document.formindex.temptext.value&returnvar=opener.document.formindex.temptext.value&fun=ReturnHtml','edittemp','width=880,height=600,scrollbars=auto,resizable=yes');"><strong>模板在线编辑</strong></a>进行可视化编辑</div></td>
      </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
          <textarea name="temptext" rows="27" id="temptext" wrap="OFF"><?=ehtmlspecialchars(stripSlashes($r[indextemp]))?></textarea>
        </div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
    ...
    <tr id="indexshowtempvar" style="display:none"> 
      <td height="25" bgcolor="#FFFFFF"><strong>首页模板支持的变量说明</strong> 
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
          <tr bgcolor="#FFFFFF"> 
            <td height="25"> <input name="textfield" type="text" value="[!--pagetitle--]">
              :网站名称</td>
            <td> <input name="textfield2" type="text" value="[!--news.url--]">
              :网站地址</td>
            <td><input name="textfield923" type="text" value="[!--class.menu--]">
              :一级栏目导航</td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
...
?>
<br>
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=cptemp>
	<form name="formcp" method="post" action="../ecmstemp.php">
    <tr> 
    <th>控制面板模板 (<a href="../../member/cp" target="_blank">预览</a>)</th>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
          <textarea name="temptext" cols="110" rows="27" id="temptext" wrap="OFF"><?=ehtmlspecialchars(stripSlashes($r[cptemp]))?></textarea>
        </div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
...
?>
<br>
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=schalltemp>
	<form name="formschall" method="post" action="../ecmstemp.php">
    <tr> 
    <th>全站搜索模板(<a href="../../sch/sch.html" target="_blank">测试模板</a>)</th>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
          <textarea name="temptext" cols="110" rows="27" id="temptext" wrap="OFF"><?=ehtmlspecialchars(stripSlashes($r[schalltemp]))?></textarea>
        </div></td>
    </tr>
    <tr> 
...
?>
<br>
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=searchtemp>
	<form name="formsearchform" method="post" action="../ecmstemp.php">
	<?=$ecms_hashur['form']?>
    <tr> 
    <th>高级搜索表单模板 (<a href="../../../search/" target="_blank">预览</a>)</th>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
          <textarea name="temptext" cols="110" rows="27" id="temptext" wrap="OFF"><?=ehtmlspecialchars(stripSlashes($r[searchtemp]))?></textarea>
        </div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
	...
	<tr> 
      <td height="25" bgcolor="#FFFFFF">&nbsp;&nbsp;[<a href="#ecms" onClick="tempturnit(searchformshowtempvar);">显示模板变量说明</a>] 
        &nbsp;&nbsp;[<a href="#ecms" onClick="window.open('../ListClass.php<?=$ecms_hashur['ehref']?>','','width=800,height=600,scrollbars=yes,resizable=yes');">查看JS调用地址</a>] 
        &nbsp;&nbsp;[<a href="javascript:void(0)" onclick="ckggmbbl()">查看公共模板变量</a>]</td>
    </tr>
...
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=searchjstemp>
    <?=$ecms_hashur['form']?>
    <tr> 
    <th>搜索JS模板[横向]</th>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
          <textarea name="temptext" cols="110" rows="18" id="temptext"><?=ehtmlspecialchars(stripSlashes($r[searchjstemp]))?></textarea>
        </div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=searchjstemp1>
    <?=$ecms_hashur['form']?>
    <tr> 
    <th>搜索JS模板[纵向]</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=otherlinktemp>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>相关信息链接模板</th>
    </tr>
...
?>
<br>
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=gbooktemp>
<?=$ecms_hashur['form']?>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=pljstemp>
    <?=$ecms_hashur['form']?>
    <tr> 
    <th>修改评论JS调用模板</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=downpagetemp>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>修改最终下载页模板</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=downsofttemp>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>下载地址模板</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=onlinemovietemp>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>在线播放地址模板</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=listpagetemp>
    <?=$ecms_hashur['form']?>
    <tr> 
    <th>列表分页模板</th>
    </tr>
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=loginiframe>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>登陆状态模板 (<a href="../../member/iframe" target="_blank">预览</a>)</th>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"> <div align="center"> 
...
?>
<form name="form1" method="post" action="../ecmstemp.php">
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="comm-table anniuqun" id=loginjstemp>
   <?=$ecms_hashur['form']?>
    <tr> 
    <th>JS调用登陆状态模板</th>
    </tr>
