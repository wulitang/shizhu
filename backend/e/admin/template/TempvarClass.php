...
<body>
<div class="container">
<div class="nynav"><div>当前位置： <a href="../main.php">后台首页</a> > <a href="ListTempvar.php<?=$ecms_hashur['whehref']?>">管理模板变量</a> &gt; <a href="TempvarClass.php<?=$ecms_hashur['whehref']?>">管理模板变量分类</a></div></div>
<div id="tab" style="margin-top:35px;">
<div class="ui-tab-bd">
<div class="ui-tab-content">
        	<h3><span>管理模板变量分类</span></h3>
            <div class="line"></div>
<div class="jqui">
...
<?=$ecms_hashur['form']?>
       <input name=enews type=hidden id="enews" value=AddTempvarClass>
		<input name=doing type=hidden value=tempvar>
  		<tr> 
          <td style="background:#DBEAF5;">增加模板变量分类:</td>
