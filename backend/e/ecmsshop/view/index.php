...
$r=$empire->fetch1("select * from {$dbtbpre}ecms_".$tbname."_check where id='$id' limit 1");
...
{
	$titleurl=$r['titleurl'];
	printerror('此篇信息为外链，正在转到对应网站..',$titleurl,1,0,1);
}

//副表
$finfor=$empire->fetch1("select ".ReturnSqlFtextF($mid)." from {$dbtbpre}ecms_".$tbname."_check_data where id='$r[id]' limit 1");
