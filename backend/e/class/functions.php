...
function page2($num,$line,$page_line,$start,$page,$search){
	...
	$page=$page+1;
	$str='<script type="text/javascript" src="../data/js/page.js"></script>';
	$str.='<div id="ecmspage"></div>';
	$str.='
	<script>
	var hhtPage1 = new HHTPage1('.$num.','.$page.','.$totalpage.');
	var URL = "'.$url.'=";
	var Search="'.$search.'";
	URL = encodeURI(URL);
