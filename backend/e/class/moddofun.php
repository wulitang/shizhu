...
function ReturnMtemp($cname,$center){
	  $temp="<tr><td nowrap='nowrap'><label>enews.name</label></td><td>[!--enews.var--]</td></tr>";
	  $ntemp="<tr><th nowrap='nowrap'>详细内容</th><th></th></tr><tr><td colspan=2>[!--newstext--]</td></tr>";
	for($i=0;$i<count($center);$i++)
	{
		$v=$center[$i];
		if($v=="newstext")
	...
	return "<table class='news-table' cellspacing='0'>".$data."</table>";
}
